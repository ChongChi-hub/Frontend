let books = [
    { id: "B001", name: "Mã Sạch", category: "Lập Trình", price: 500, quantity: 10 },
    { id: "B002", name: "Lập Trình Viên Thực Dụng", category: "Lập Trình", price: 600, quantity: 8 },
    { id: "B003", name: "Bạn Không Biết JS", category: "Lập Trình", price: 450, quantity: 15 },
    { id: "B004", name: "JavaScript Hùng Biện", category: "Lập Trình", price: 550, quantity: 5 },
    { id: "B005", name: "JavaScript: Những Phần Tinh Túy", category: "Lập Trình", price: 400, quantity: 12 },
    { id: "B006", name: "Mẫu Thiết Kế", category: "Kỹ Thuật Phần Mềm", price: 700, quantity: 7 }
];
let cart = [];
...
function searchBook() {
    ...
    const results = books.filter(book => book.name.toLowerCase().includes(keyword) || book.id.toLowerCase().includes(keyword));
